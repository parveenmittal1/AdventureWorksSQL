...
- **URL**: [Part 1 - Getting used to beginner level of SQL commands](https://github.com/parveenmittal1/AdventureWorksSQL/blob/main/AW-Project-Part-1.sql)
...
- **URL**: [Part 2 - Diving Deeper into Data Manipulation](https://github.com/parveenmittal1/AdventureWorksSQL/blob/main/AW-Project-Part-2.sql)
...
- **URL**: [Part 3 - SQL Metamorphosis: Crafting with REPLACE, CAST, and NTILE](https://github.com/parveenmittal1/AdventureWorksSQL/blob/main/AW-Project-Part-3.sql)
...
- **URL**: [Part 4 - SQL Shapeshifters: Introduction to Data Ranking and Splitting](https://github.com/parveenmittal1/AdventureWorksSQL/blob/main/AW-Project-Part-4.sql)
...
- **URL**: [Part 5 - Introduction to Functions: Learning about Table-Returned Functions](https://github.com/parveenmittal1/AdventureWorksSQL/blob/main/AW-Project-Part-5.sql)
...
- **URL**: [Part 6 - Dynamic SQL and Stored Procedures](https://github.com/parveenmittal1/AdventureWorksSQL/blob/main/AW-Project-Part-6.sql)
...
- **URL**: [Part 7 - Advanced Procedures and Function Problems](https://github.com/parveenmittal1/AdventureWorksSQL/blob/main/AW-Project-Part-7.sql)
...
- **URL**: [Part 8 - The Art of SQL Logic: Looping Techniques and Conditional Structures](https://github.com/parveenmittal1/AdventureWorksSQL/blob/main/AW-Project-Part-8.sql)
